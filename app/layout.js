...
export default function RootLayout({ children }) {
  return (
    <html lang="en" className="scroll-smooth">
      ...
      <body className={`${inter.variable} min-h-screen bg-slate-50 text-slate-900 font-sans antialiased overflow-x-hidden selection:bg-cyan-400/20 selection:text-slate-900`}>
