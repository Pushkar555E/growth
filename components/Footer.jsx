        ...
        <div className="lg:col-span-4 space-y-6">
          <Link href="/" id="footer-logo" className="inline-flex items-center group mb-6">
            <img 
              ...
              alt="Growth Nest" 
              className="w-56 sm:w-72 md:w-[360px] h-auto object-contain transition-transform duration-300 group-hover:scale-[1.02]" 
            />
          </Link>
          ...
          <div className="flex flex-wrap gap-4 mt-6">
            ...
            <a href="#" className="p-2 rounded-lg bg-slate-100 border border-slate-200 text-slate-500 hover:text-slate-900 hover:border-slate-300 transition-all duration-200" aria-label="Facebook">
