    ...
    <footer className="border-t border-slate-200/60 bg-slate-50 py-16" aria-label="Agency Footer">
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="flex flex-wrap gap-4 mt-6">
            <a href="https://wa.me/916290819569" target="_blank" rel="noreferrer noopener" className="p-2 rounded-lg bg-emerald-50 border border-emerald-200 text-emerald-600 hover:text-emerald-700 hover:border-emerald-300 transition-all duration-200" aria-label="WhatsApp">
            ...
            <a href="#" className="p-2 rounded-lg bg-blue-50 border border-blue-200 text-[#1877F2] hover:bg-blue-100 hover:border-blue-300 transition-all duration-200" aria-label="Facebook">
            ...
            <a href="#" className="p-2 rounded-lg bg-sky-50 border border-sky-200 text-[#0A66C2] hover:bg-sky-100 hover:border-sky-300 transition-all duration-200" aria-label="LinkedIn">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
              </svg>
            </a>
            <a href="#" className="p-2 rounded-lg bg-slate-100 border border-slate-300 text-black hover:bg-slate-200 hover:border-slate-400 transition-all duration-200" aria-label="Twitter">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
              </svg>
            </a>
            <a href="#" className="p-2 rounded-lg bg-pink-50 border border-pink-200 text-[#E1306C] hover:bg-pink-100 hover:border-pink-300 transition-all duration-200" aria-label="Instagram">
            ...
            <a href="#" className="p-2 rounded-lg bg-red-50 border border-red-200 text-[#FF0000] hover:bg-red-100 hover:border-red-300 transition-all duration-200" aria-label="YouTube">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
